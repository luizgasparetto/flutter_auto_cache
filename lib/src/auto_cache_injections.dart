...
class AutoCacheInjections {
  ...
  static void _registerCore() {
    ...
    ServiceLocator.instance.bindFactory<IKvsService>(() => SharedPreferencesKvsService(_get()));
    ServiceLocator.instance.bindFactory<ICryptographyService>(() => EncryptCryptographyService(_get(), _get()));
  ...
  static void _registerDataCache() {
    ServiceLocator.instance.bindFactory<IQueryDataCacheDatasource>(() => QueryDataCacheDatasource(_get(), _get(), _get()));
