...
sealed class ISubstitutionCacheStrategy {
  ...
  AsyncResult<Unit> substitute<T extends Object>(DataCacheEntity<T> value) {
  ...
  AsyncResult<Unit> deleteDataCache<T extends Object>(String key, DataCacheEntity<T> data) async {
  ...
  AsyncResult<Unit> _handleAccomodate<T extends Object>(String key, DataCacheEntity<T> data) async {
