...
class FakeDataCacheEntity extends Fake implements DataCacheEntity<String> {
  ...
  FakeDataCacheEntity({required this.index});

  @override
  String get id => 'key_$index';
...
void main() {
  ...
  final sut = MruSubstitutionCacheStrategy(dataRepository, substitutionRepository);
  ...
  group('MruSubstitutionCacheStrategy.substitute |', () {
  ...
  group('MruSubstitutionCacheStrategy.getKeys |', () {
    final previewList = List.generate(3, (index) => FakeDataCacheEntity(index: index));
    final cacheList = [...previewList, null];
